...
## Project Structure
    ...
    ├── testapiautosetting_126970  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126970`
...
2. Clone this repo and `cd testapiautosetting_126970`
